...
bot = telebot.TeleBot("7526710542:AAFLlyLScM5zY4mrDKh1hmavmVsapBC79s4")
...
def photo_handler(message):
    ...
    bot.reply_to(message, f"{ai_image()[0][2:]}")
    bot.reply_to(message, f"С шансом: {str(ai_image()[1]*100)[0:5]}%")
